...
<script>
  ...
  export default {
    ...
    props: {
      caption: {
        type: String,
        default: 'Reporte de activos en demasía'
      },
      hover: {
        type: Boolean,
        default: true
    ...
    methods: {
      ...
      async search(){
        this.flag = false;
        const assets = await reports.getExceededFinalAssetsReport(this.$session.get('projectID'),this.departmentID,this.deptTree);
        var localitems = [];
